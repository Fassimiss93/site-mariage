...
.env-overlay.env-open .env-letter { transform: translateY(-42px); transition-delay: 0.55s; }
.env-letter-ornament {
...
.env-overlay.env-open .env-flap { transform: rotateX(180deg); }
.env-seal {
